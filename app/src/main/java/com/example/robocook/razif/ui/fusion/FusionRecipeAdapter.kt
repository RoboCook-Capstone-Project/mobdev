...
import com.example.robocook.databinding.ItemFusionRecipeBinding
import com.example.robocook.razif.data.response.RecipeList

class FusionRecipeAdapter : RecyclerView.Adapter<FusionRecipeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemFusionRecipeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(private val binding: ItemFusionRecipeBinding) : RecyclerView.ViewHolder(binding.root) {
